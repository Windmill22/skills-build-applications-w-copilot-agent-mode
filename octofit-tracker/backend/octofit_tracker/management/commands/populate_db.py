...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        octo_models.Workout.objects.create(name='Morning Cardio', description='A quick morning run', suggested_for=marvel)
        octo_models.Workout.objects.create(name='Strength Training', description='Heavy lifting', suggested_for=dc)
